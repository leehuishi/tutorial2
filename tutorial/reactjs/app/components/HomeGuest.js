...
function HomeGuest() {
        ...
        if(state.submitCount){
            ...
            async function fetchResults(){
                try{
                    //a = url, b = data send along, c = 
                    //submit request 
                    await Axiosinstance.post('/register', {username: state.username.value, password: state.password.value}) //create user
    ...
    async function handleSubmit(e){
        e.preventDefault()
        // try{
        //     await Axiosinstance.post('/register', {username: username, password: password})
        //     console.log("User was successfully created.")
        // }
        // catch(e){
